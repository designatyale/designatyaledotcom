 ...
 * 2023 Design at Yale
 *
 * https://github.com/algolia/doc-code-samples/blob/master/react-instantsearch/facet-dropdown/src/components/FacetDropdown.tsx
 */
...
export function FacetDropdown({
  ...
  const header = (
    <button
      type="button"
      className={cx(
        s['ais-Dropdown-button'],
        classNames.button,
        isRefined &&
          cx(s['ais-Dropdown-button--refined'], classNames.buttonRefined),
        isDisabled && s['ais-Dropdown-button--disabled']
      )}
      disabled={isDisabled}
  ...
  return (
    <Panel
      ...
      className={cx(
        s['ais-Dropdown'],
        isOpened && s['ais-Dropdown--opened'],
        classNames.root
      )}
      ref={panelRef}
    >
      <DropdownMiddleware
        ...
        close={close}
      />
      <h2 className={cx(s['ais-Dropdown-mobileTitle'], classNames.mobileTitle)}>
        {text}
      </h2>
      {children}
    </Panel>
